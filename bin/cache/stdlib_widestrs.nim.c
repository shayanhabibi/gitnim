...
N_LIB_PRIVATE N_NIMCALL(NI16*, newWideCString__K8rR70TBwrP6FNBzDhVVOA)(NCSTRING source, NI L) {
	...
	result = (NI16*) newObj((&NTI__4HwedE75WPfqZSQ0Cq2OUg_), ((NI) ((NI)(TM__R8z9bzATizpQoD67YeHNTdg_8))));
	d = ((NI) 0);
	{
		NI ch;
		NI i;
