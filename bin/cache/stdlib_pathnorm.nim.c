...
STRING_LITERAL(TM__DfU0iuayCGwHDN1Exp9cbKg_19, ".", 1);
...
N_LIB_PRIVATE N_NIMCALL(tyTuple__1v9bKyksXWMsm0vNwmZ4EuQ, next__am1q4dBd9cls9au5CcmkX5oA)(tyObject_PathIter__tllF14xUpDWpqG9ci5sg9bMg* it, NimStringDesc* x) {
	...
	(*it).prev = (*it).i;
	{
		...
		(*it).i = (NI)(TM__DfU0iuayCGwHDN1Exp9cbKg_3);
		{
			...
			if ((NU)((NI)(TM__DfU0iuayCGwHDN1Exp9cbKg_5)) >= (NU)(x ? x->Sup.len : 0)){ raiseIndexError2((NI)(TM__DfU0iuayCGwHDN1Exp9cbKg_5),(x ? x->Sup.len : 0)-1); }
...
static N_INLINE(NIM_CHAR, X5BX5D___okzHJ6GE9cv0bYG3b4r5KCAsystem)(NimStringDesc* s, NI i) {
	...
	result = (NIM_CHAR)0;
	if (nimSubInt((s ? s->Sup.len : 0), i, &TM__DfU0iuayCGwHDN1Exp9cbKg_10)) { raiseOverflow(); };
	if ((NU)((NI)(TM__DfU0iuayCGwHDN1Exp9cbKg_10)) >= (NU)(s ? s->Sup.len : 0)){ raiseIndexError2((NI)(TM__DfU0iuayCGwHDN1Exp9cbKg_10),(s ? s->Sup.len : 0)-1); }
	result = s->data[(NI)(TM__DfU0iuayCGwHDN1Exp9cbKg_10)];
	return result;
}
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, isDotDot__Sl9c33djPmHfV9bnZbQf0QBw_2)(NimStringDesc* x, tyTuple__1v9bKyksXWMsm0vNwmZ4EuQ bounds) {
	NIM_BOOL result;
	...
	if ((NU)((NI)(TM__DfU0iuayCGwHDN1Exp9cbKg_12)) >= (NU)(x ? x->Sup.len : 0)){ raiseIndexError2((NI)(TM__DfU0iuayCGwHDN1Exp9cbKg_12),(x ? x->Sup.len : 0)-1); }
				...
				if (!T26_) goto LA27_;
				{
					...
					d = ((*result) ? (*result)->Sup.len : 0);
					{
						while (1) {
							...
							T35_ = ((NI)((*state) & ((NI) 1)) < (NI)(TM__DfU0iuayCGwHDN1Exp9cbKg_13));
							if (!(T35_)) goto LA36_;
							if (nimSubInt(d, ((NI) 1), &TM__DfU0iuayCGwHDN1Exp9cbKg_14)) { raiseOverflow(); };
							if ((NU)((NI)(TM__DfU0iuayCGwHDN1Exp9cbKg_14)) >= (NU)((*result) ? (*result)->Sup.len : 0)){ raiseIndexError2((NI)(TM__DfU0iuayCGwHDN1Exp9cbKg_14),((*result) ? (*result)->Sup.len : 0)-1); }
							T35_ = !((((NU8)((*result)->data[(NI)(TM__DfU0iuayCGwHDN1Exp9cbKg_14)])) == ((NU8)(92)) || ((NU8)((*result)->data[(NI)(TM__DfU0iuayCGwHDN1Exp9cbKg_14)])) == ((NU8)(47))));
							LA36_: ;
							if (!T35_) goto LA34;
...
appendString((*result), T64_);
				if (nimAddInt((*state), ((NI) 2), &TM__DfU0iuayCGwHDN1Exp9cbKg_18)) { raiseOverflow(); };
	...
	}
	{
		...
		LA68_: ;
		if (!T67_) goto LA69_;
		unsureAsgnRef((void**) (&(*result)), copyString(((NimStringDesc*) &TM__DfU0iuayCGwHDN1Exp9cbKg_19)));
	}
	LA69_: ;
}
